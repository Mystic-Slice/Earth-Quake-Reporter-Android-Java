...
public final class QueryUtils {
    ...
    private static final String SAMPLE_JSON_RESPONSE = "{\"type\":\"FeatureCollection\"," +
            "\"metadata\":{\"generated\":1462295443000,\"url\":\"http://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2016-01-01&endtime=2016-01-31&minmag=6&limit=10\",\"title\":\"USGS Earthquakes\",\"status\":200,\"api\":\"1.5.2\",\"limit\":10,\"offset\":1,\"count\":10}," +
     ...
     */
    public static ArrayList<Event> extractEarthquakes() {
        ...
        try {
            ...
            JSONObject earthQuakeQueryResponse = new JSONObject(SAMPLE_JSON_RESPONSE);
            JSONArray quakesList = earthQuakeQueryResponse.getJSONArray("features");
            for(int i = 0;i<quakesList.length();i++){
                JSONObject quake = new JSONObject();
                quake = quakesList.getJSONObject(i);
